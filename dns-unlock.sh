...
# 指定配置文件的下载地址
CONFIG_URL="https://raw.githubusercontent.com/hkfires/DNS-Alice-Unlock/refs/heads/main/dnsmasq.conf"
...
3)
  ...
  1)
    # 更新为 HK 配置
    CONFIG_URL="https://raw.githubusercontent.com/hkfires/DNS-Alice-Unlock/refs/heads/main/dnsmasq.conf.hk"
    TARGET_FILE="dnsmasq.conf.hk"
    REGION="HK"
    ;;
  2)
    # 更新为 SG 配置
    CONFIG_URL="https://raw.githubusercontent.com/hkfires/DNS-Alice-Unlock/refs/heads/main/dnsmasq.conf.sg"
    TARGET_FILE="dnsmasq.conf.sg"
    REGION="SG"
    ;;
  3)
    # 更新为全量配置
    CONFIG_URL="https://raw.githubusercontent.com/hkfires/DNS-Alice-Unlock/refs/heads/main/dnsmasq.conf.allsg"
...
curl -o /etc/smartdns/smartdns.conf https://raw.githubusercontent.com/hkfires/DNS-Alice-Unlock/refs/heads/main/smartdns.conf
if [ $? -ne 0 ]; then
...
;;
 ...
 3)
    ...
    4)
      # 一键更新全量配置
      CONFIG_URL="https://raw.githubusercontent.com/hkfires/DNS-Alice-Unlock/refs/heads/main/smartdns.conf.sg"
